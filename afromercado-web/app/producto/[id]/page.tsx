              ...
              {producto.esExpress && producto.comercioId ? (
                ...
                enlaceWa ? (
                  <a
                    ...
                    className="w-full min-h-[56px] font-bold text-base rounded-2xl bg-[#25D366] hover:bg-[#1ebe5a] text-white transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                  ...
                  <div className="w-full min-h-[56px] rounded-2xl bg-[#F0EBE3] border border-[#E8DCC8] flex items-center justify-center px-4 text-sm text-[#666] text-center">
        ...
        <section className="max-w-6xl mx-auto w-full px-4 md:px-6 py-6">
          <div className="bg-white rounded-2xl border border-[#1A1A1A]/8 p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {/* Compartir producto — genérico (WhatsApp, redes, correo, etc.),
                  no limitado a un solo canal. Ver handleCompartir arriba. */}
              <button
                type="button"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#1A1A1A]/10 px-4 py-3 flex items-center justify-between gap-4">
        ...
        {producto.comercio.comprableEnPlataforma === false ? (
          enlaceWa ? (
            ...
            <span className="flex-shrink-0 text-xs text-[#1A1A1A]/40 max-w-[140px]">
              Contacto directo — visita el perfil del vendedor
            </span>
          )
        ) : (
          <button
