...
/** Obtiene una alianza publicada por su código compartido. Ruta pública, no requiere sesión. */
...
/** Lista alianzas publicadas filtradas por región (departamento/municipio) y fecha vigente. Ruta pública. */
