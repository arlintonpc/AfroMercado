...
export default function TarjetaOfertaEmpleo({
  ...
  return (
    <div className="group bg-white rounded-2xl border border-[#1A1A1A]/8 overflow-hidden hover:border-[#2D6A4F]/25 hover:shadow-[0_8px_24px_rgba(45,106,79,0.08)] transition-all duration-200">
      {tieneImagen && (
      ...
      <div className="p-5">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-2">
              <Link href={`/empleo/${oferta.id}`} className="block min-w-0">
                <p className="font-semibold text-[#1A1A1A] leading-snug group-hover:text-[#2D6A4F] transition-colors">{oferta.titulo}</p>
        ...
        <div className="flex items-end justify-between gap-3 mt-4 pt-3.5 border-t border-[#1A1A1A]/6">
          <div>
            <p className="text-base font-bold text-[#1B4332]">{salarioTexto(oferta)}</p>
