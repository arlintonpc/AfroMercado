...
async function main() {
  ...
  const CATEGORIAS_SEED = [
    ...
    { nombre: "Cultural",             slug: "cultural",            icono: "🎭" },
    { nombre: "Turismo",              slug: "turismo",             icono: "🏞️" },
  ];
  ...
  const productosSpec = [
    ...
    {
      comercio: "Mujeres Emprendedoras del Pacífico",
      categoriaSlug: "cultural",
      nombre: "Chaquira artesanal — collar ceremonial",
      descripcion: "Collar tejido con chaquiras de colores por mujeres del Litoral Pacífico. Inspirado en la iconografía afro-chocoana. Pieza única, hecha a mano.",
      precio: 35000,
      unidad: "UNIDAD",
      pesoKg: 0.1,
      diasAlistamientoMin: 4,
      diasAlistamientoMax: 10,
      alcance: "NACIONAL",
    },
    {
      comercio: "Mujeres Emprendedoras del Pacífico",
      categoriaSlug: "cultural",
      nombre: "Libro: Memoria oral del Litoral Pacífico",
      descripcion: "Recopilación de relatos, mitos y tradiciones orales de las comunidades afrocolombianas del Chocó. 180 páginas, edición artesanal con ilustraciones locales.",
      precio: 28000,
      unidad: "UNIDAD",
      pesoKg: 0.4,
      diasAlistamientoMin: 2,
    ...
    },
    {
      comercio: "Mujeres Emprendedoras del Pacífico",
      categoriaSlug: "cultural",
      nombre: "Kit de instrumentos ancestrales del Chocó",
      descripcion: "Conjunto artesanal: guacharaca, maracas y cununo en miniatura. Elaborados por artesanos locales con maderas nativas. Ideal para coleccionistas y amantes de la música del Pacífico.",
      precio: 75000,
      unidad: "PAQUETE",
      pesoKg: 1.2,
      diasAlistamientoMin: 5,
    ...
    {
      comercio: "Finca Agroforestal Baudó",
      categoriaSlug: "turismo",
      nombre: "Tour en lancha por el río Baudó (hasta 8 personas)",
      descripcion: "Recorrido fluvial por el río Baudó: flora, fauna y comunidades indígenas. Incluye guía local, hidratación y equipo de seguridad. Duración: 4 horas. Coordinar fecha por WhatsApp antes de comprar.",
      precio: 180000,
      unidad: "PAQUETE",
      pesoKg: 0.1,
      diasAlistamientoMin: 2,
    ...
    },
    {
      comercio: "Finca Agroforestal Baudó",
      categoriaSlug: "turismo",
      nombre: "Caminata ecológica por selva chocoana (3h, hasta 4 personas)",
      descripcion: "Sendero guiado por selva tropical del Chocó: observación de aves, plantas medicinales y cascadas. Guía bilingüe (español/embera). Punto de encuentro: Finca Agroforestal Baudó, Quibdó.",
      precio: 65000,
      unidad: "UNIDAD",
      pesoKg: 0.1,
      diasAlistamientoMin: 1,
    ...
    },
    {
      comercio: "Finca Agroforestal Baudó",
      categoriaSlug: "turismo",
      nombre: "Estadía 2 noches — Finca Agroforestal Baudó (2 personas)",
      descripcion: "Alojamiento rústico rodeado de selva: hamacas, patio de observación nocturna, desayuno incluido con frutas tropicales. Vivencia de campo auténtica en el Chocó. Confirmar fechas por WhatsApp antes de comprar.",
      precio: 250000,
      unidad: "PAQUETE",
      pesoKg: 0.1,
      diasAlistamientoMin: 3,
