...
function codigoRecuperacion({ nombre, codigo }) {
  const contenido = `
    ...
    <p style="color:#555;line-height:1.6;">Hola ${nombre}, recibimos una solicitud para restablecer la contraseña de tu cuenta en Teravia.</p>
  ...
  return base(contenido, "Código de recuperación — Teravia");
}
